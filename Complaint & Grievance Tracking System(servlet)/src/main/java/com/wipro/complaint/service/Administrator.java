...
public class Administrator {
    ...
    public String addRecord(ComplaintBean bean) {
        ...
        try {
            ...
            if (bean == null || bean.getComplainant() == null
                    || bean.getTitle() == null
            ...
            String id = dao.generateComplaintID(bean.getTitle(), bean.getComplaintDate());
            bean.setComplaintId(id);
            bean.setStatus("OPEN");
    ...
    public ComplaintBean viewRecord(String title, Date date) {
